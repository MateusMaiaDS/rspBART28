...
source("R/sim_functions_28.R")
source("R/main_function_28.R")
devtools::load_all()
...
saveRDS(object = rsp_mod,file = paste0("/users/research/mmarques/spline_bart_lab/preliminar_results/rspBART28/",type_,"/single_run/v31_grid_single_run_rep_",
