...
# All BART-lite interaction
all_spbart_lite_interaction_28 <- function(cv_element,
                                        nIknots_,
                                        node_min_size_,
                                        ntree_,
                                        seed_,
  ...
  # Storing predictions as well
  y_train_hat_predictions <- spBART_interaction$y_train_hat
  y_test_hat_predictions <- spBART_interaction$y_test_hat
  ...
  return(list(comparison_metrics = comparison_metrics,
              y_train_hat_predictions = y_train_hat_predictions,
              y_test_hat_predictions = y_test_hat_predictions,
              all_tau = all_tau))
